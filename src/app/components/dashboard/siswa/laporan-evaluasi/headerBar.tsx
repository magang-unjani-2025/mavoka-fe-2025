//"use client";
//export default function HeaderBar({ onAdd }: { onAdd: () => void }) {
//  return (
...
//      <button
//        onClick={onAdd}
//        className="inline-flex items-center gap-2 rounded-lg bg-[#0F67B1] px-3 py-2 text-white shadow hover:bg-blue-700"
//      >
