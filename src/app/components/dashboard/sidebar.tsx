...
//import { HiOutlineBriefcase, HiOutlineBookOpen,HiOutlineDocumentAdd, HiOutlineClipboardList } from "react-icons/hi";
...
//      { name: "Upload Pelatihan", href: "/dashboard-lpk/pelatihan", icon: <HiOutlineDocumentAdd size={20} />},
//      { name: "Penilaian Siswa", href: "/dashboard-lpk/penilaian", icon: <HiOutlineClipboardList size={20} />},
//            {
//        name: "Pengaturan",
