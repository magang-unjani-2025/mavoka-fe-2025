...
export default function Sidebar({ role, isOpen, setIsOpen }: SidebarProps) {
  ...
  const menus: Record<typeof role, MenuItem[]> = {
    admin: [
      ...
      { name: "Kelola Akun", href: "/dashboard-admin/users", icon: <Users size={20} /> },
      { name: "Laporan Umum", href: "/dashboard-admin/reports", icon: <FileText size={20} /> },
    ],
    perusahaan: [
    ...
    siswa: [
      ...
      { name: "Pelaksanaan Magang", href: "/dashboard-siswa/pelaksanaan-magang", icon: <HiOutlineBookOpen size={20} /> },
      { name: "Pengaturan", href: "/dashboard-siswa/pengaturan", icon: <MdOutlineSettings size={20} /> },
    ],
  };
