...
//    <div
//      className={`
//      flex flex-row items-center gap-3 border-b py-2 px-4
//      transition-all duration-300 h-[84px]
//    `}
//    >
//      <button
//        onClick={onToggle}
//        className="hover:bg-gray-100 rounded-none shadow-none p-0"
...
//          width={140}
//          height={40}
//          className="transition-all duration-300 mt-[-7px]"
//          priority
//        />
//      ) : null}
//    </div>
