...
//type TopNavbarProps = {
//  /** 
//   * "siswa" → tampilkan: Nama lengkap + nama sekolah 
//   * "welcome" → tampilkan: SELAMAT DATANG + "Hi, OrgName..."
//   */
//  variant: "siswa" | "welcome";

//  /** Nama lengkap (untuk varian siswa dan avatar) */
//  fullName?: string;

//  /** Nama sekolah / LPK / perusahaan (dipakai subjudul / welcome) */
//  orgName?: string;
...
//  className = "",
//}: TopNavbarProps) {
//  console.log("[TopNavbar] variant =", variant, "fullName =", fullName, "orgName =", orgName);

//  return (
//    <div
//      className={`flex items-center justify-between px-6 py-4 border-b bg-white shadow-xl ${className}`}
//    >
//      {/* Left area */}
//      {variant === "siswa" ? (
//        <div className="min-w-0">
//          {/* Contoh: "Lisa Mariana Treynggar Amsori" */}
//          <h3 className="font-semibold text-gray-900 truncate">{fullName}</h3>
//          {/* Contoh: "SMKN 1 Yogyakarta" */}
//          <small className="text-sm text-gray-500 truncate">{orgName}</small>
//        </div>
//      ) : (
//        <div className="min-w-0">
...
type TopNavbarProps = {
  ...
  onBellClick?: () => void;
  className?: string;
  // buka drawer sidebar untuk mobile
  onMobileOpen?: () => void;
  // ⬇️ tetap opsional di tipe, tapi TIDAK dirender agar tidak dobel
