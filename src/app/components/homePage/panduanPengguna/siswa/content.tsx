"use client";
import { siswaGuide } from "../dataDropdown/siswaGuide";
import AccordionUtama from "../dropDown/AccordionUtama";

export default function SiswaContent() {
  return (
    <>
    <section className="text-center px-4 tablet:px-6 desktop:px-10 py-8">
      <h2 className="font-semibold text-[#0F67B1] mb-4">
        Informasi mengenai Panduan Siswa
      </h2>
