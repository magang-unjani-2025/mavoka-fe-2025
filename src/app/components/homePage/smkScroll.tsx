...
export default function SmkLogoMarquee() {
  ...
  return (
    <section className="py-8">
      <Container>
        <h2 className="text-xl tablet:text-2xl font-semibold text-center mb-4">
          SMK NEGERI & SWASTA
        </h2>
      </Container>
                ...
                >
                  {item.logo ? (
                    <Image
                      ...
                      width={80}
                      height={80}
                      className="object-contain w-16 h-16 tablet:w-20 tablet:h-20 desktop:w-24 desktop:h-24"
                    />
                  ) : (
                    <HiUser className="text-black w-16 h-16 tablet:w-20 tablet:h-20 desktop:w-24 desktop:h-24" />
                  )}
                </div>
              ))}
            </div>
