...
//        <div className="max-w-7xl mx-auto px-[70px] flex flex-col lg:flex-row justify-between gap-10">

//          {/* Kolom Logo + Deskripsi */}
//          <div className="max-w-[420px] mt-9">
...
//          {/* Quick Link */}
//          <div>
//            <h3 className="text-black font-semibold mt-9 mb-7">Quick link</h3>
//            <ul className="space-y-2 text-black text-sm mb-5">
